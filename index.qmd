...
```{=html}
<button class="bio-toggle" type="button" aria-expanded="false">More About Me</button>
```
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var quickbar = document.querySelector(".home-page .mobile-quickbar");
  if (!bio || !toggle) return;

  toggle.addEventListener("click", function () {
    var expanded = bio.classList.toggle("is-expanded");
    toggle.setAttribute("aria-expanded", expanded ? "true" : "false");
    toggle.textContent = expanded ? "Show Less" : "More About Me";
  });
  ...
  var updateQuickbar = function () {
    ...
    quickbar.classList.toggle("is-visible", window.scrollY > 360);
  };
...
::: {.appointment-group}
<p class="appointment-role">Director of the Frick Initiatives</p>
<p class="appointment-institution">Washington University in St. Louis</p>
:::
...
```{=html}
<a class="research-card-hit" href="research/" aria-label="Explore research themes"></a>
```
:::
:::
...
```{=html}
<nav class="mobile-quickbar" aria-label="Mobile quick navigation">
