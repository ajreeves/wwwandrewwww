...
::: profile-text
Andrew Reeves is a political scientist whose work examines the presidency, democratic accountability, and the intersection of geography and politics. As Director of the [Weidenbaum Center](http://wc.wustl.edu), he leads cross-disciplinary initiatives that connect research, policy, and public engagement, overseeing major investments in faculty scholarship, student learning, and public programming. In his role as Senior Advisor to the [Chancellor](https://andrewdmartin.washu.edu/), Reeves helps advance university-wide efforts that strengthen academic freedom, foster open dialogue, and promote collaboration across disciplines. He is also a Visiting Fellow at the [Hoover Institution](https://www.hoover.org). 
