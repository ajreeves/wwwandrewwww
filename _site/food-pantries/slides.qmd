...
<div class="about-grid">
  ...
  <div class="about-card">
    ...
    <div class="about-title">Professor of Political Science<br><span class="about-affil">Washington University in St. Louis</span></div>
  </div>
  <div class="about-card">
    ...
    <div class="about-title">Director, Weidenbaum Center<br>Professor of Political Science<br>Senior Advisor to the Chancellor<br><span class="about-affil">Washington University in St. Louis</span></div>
  </div>
  <div class="about-card">
    ...
    <div class="about-title">Ph.D. Student in Political Science<br><span class="about-affil">Washington University in St. Louis</span></div>
  </div>
  <div class="about-card">
  ...
  <div class="about-card">
    ...
    <div class="about-title">Postdoctoral Fellow at the Weidenbaum Center<br><span class="about-affil">Washington University in St. Louis</span></div>
  </div>
</div>
```
...
::: {.map-embed}
```{=html}
<iframe src="map4_source_compare_interactive.html" data-external="1" title="Pantry source comparison map"></iframe>
```
:::

<span class="slide-footnote">If the embedded map does not load on your device, open the standalone version: <a href="map4_source_compare_interactive.html" target="_blank" rel="noopener">map4_source_compare_interactive.html</a>.</span>
